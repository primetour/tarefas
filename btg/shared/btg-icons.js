/**
 * Biblioteca pequena de ícones SVG inline — equivalente vanilla do
 * Lucide Icons usado no Next.js. Apenas os ícones que aparecem nos
 * sites BTG / Operadora.
 *
 * Uso: `icon('chevron-right', 'icon-sm')` → string SVG.
 */
...
const ICONS = {
  ...
  'drama': '<path d="M10 11h.01"/><path d="M14 7h.01"/><path d="M14 11h.01"/><path d="M14 15v2a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-2"/><path d="M2 15.5V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v12.5a1 1 0 0 1-1.85.53L13 13l-1.85 3.03A1 1 0 0 1 9 16V14"/><path d="m9 14-2-2"/>',
 ...
 */
export function icon(name, className = 'icon-md') {
  const body = ICONS[name];
  if (!body) return '';
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="${className}" aria-hidden="true">${body}</svg>`;
}
