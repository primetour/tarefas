# Onboarding — Gestor PRIMETOUR

> Atualizado: 2026-05-04
> Público-alvo: dev novo no projeto. Setup do zero em ~15 min.
...
│   ├── ONBOARDING.md       # Este arquivo (setup pra dev novo)
...
Pra entender o sistema (em ordem recomendada):
1. [`ARCHITECTURE.md`](./ARCHITECTURE.md) — visão técnica + decisões + camadas
2. [`CONTRIBUTING.md`](./CONTRIBUTING.md) — convenções + workflow PR + anti-padrões
3. [`PERFORMANCE.md`](./PERFORMANCE.md) — otimizações + custos Firestore
...
- [`../ACCESS-CONTROL.md`](../ACCESS-CONTROL.md) — 6 roles + 50+ permissões
...
- Bugs em produção: ver [`../INCIDENT-RESPONSE.md`](../INCIDENT-RESPONSE.md)
- Arquitetura: [`ARCHITECTURE.md`](./ARCHITECTURE.md)
- Performance/custos: [`PERFORMANCE.md`](./PERFORMANCE.md)
