...
function setupRouter() {
  ...
  router.register({
    ...
    'office':       async () => { const { renderOffice, destroyOffice } = await import('./pages/office.js?v=20260512oo7'); window.__officeDestroy = destroyOffice; await renderOffice(content); },
