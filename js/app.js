...
import { renderDashboards, destroyDashboards } from './pages/dashboards.js?v=20260503bbb1';
...
import { renderNlPerformance }            from './pages/nlPerformance.js?v=20260503bbb1';
import { renderMetaPerformance }          from './pages/metaPerformance.js?v=20260503bbb1';
import { renderGaPerformance }            from './pages/gaPerformance.js?v=20260503bbb1';
...
import { renderPortalDashboard }          from './pages/portalDashboard.js?v=20260503bbb1';
...
import { renderRoteiroDashboard, destroyRoteiroDashboard } from './pages/roteiroDashboard.js?v=20260503bbb1';
import { renderContentCalendar }         from './pages/contentCalendar.js';
import { renderLuxuryTravel }            from './pages/luxuryTravel.js?v=20260503bbb1';
import { renderLuxuryTravelAdmin }       from './pages/luxuryTravelAdmin.js?v=20260503bbb1';
...
function setupRouter() {
  ...
  store.subscribe('activeWorkspaces', () => {
    ...
    const refreshMap = {
      ...
      'dashboards':() => { destroyDashboards(); import('./pages/dashboards.js?v=20260503bbb1').then(m => m.renderDashboards(content)); },
