...
function setupRouter() {
  ...
  router.register({
    ...
    'office':       async () => { const { renderOffice, destroyOffice } = await import('./pages/office.js?v=20260512o11'); window.__officeDestroy = destroyOffice; await renderOffice(content); },
