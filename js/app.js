...
import { renderDashboards, destroyDashboards } from './pages/dashboards.js?v=20260503rr2';
...
function setupRouter() {
  ...
  store.subscribe('activeWorkspaces', () => {
    ...
    const refreshMap = {
      ...
      'dashboards':() => { destroyDashboards(); import('./pages/dashboards.js?v=20260503rr2').then(m => m.renderDashboards(content)); },
