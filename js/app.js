...
import { renderDashboards, destroyDashboards } from './pages/dashboards.js?v=20260503ss1';
...
function setupRouter() {
  ...
  store.subscribe('activeWorkspaces', () => {
    ...
    const refreshMap = {
      ...
      'dashboards':() => { destroyDashboards(); import('./pages/dashboards.js?v=20260503ss1').then(m => m.renderDashboards(content)); },
