...
import { renderDashboards, destroyDashboards } from './pages/dashboards.js?v=20260503zz1';
...
import { renderNlPerformance }            from './pages/nlPerformance.js?v=20260503zz1';
import { renderMetaPerformance }          from './pages/metaPerformance.js?v=20260503zz1';
import { renderGaPerformance }            from './pages/gaPerformance.js?v=20260503zz1';
...
import { renderPortalDashboard }          from './pages/portalDashboard.js?v=20260503zz1';
...
import { renderRoteiroDashboard, destroyRoteiroDashboard } from './pages/roteiroDashboard.js?v=20260503zz1';
...
function setupRouter() {
  ...
  store.subscribe('activeWorkspaces', () => {
    ...
    const refreshMap = {
      ...
      'dashboards':() => { destroyDashboards(); import('./pages/dashboards.js?v=20260503zz1').then(m => m.renderDashboards(content)); },
