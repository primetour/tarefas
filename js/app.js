...
import { renderDashboards, destroyDashboards } from './pages/dashboards.js?v=20260503vv2';
...
import { renderNlPerformance }            from './pages/nlPerformance.js?v=20260503vv2';
...
function setupRouter() {
  ...
  store.subscribe('activeWorkspaces', () => {
    ...
    const refreshMap = {
      ...
      'dashboards':() => { destroyDashboards(); import('./pages/dashboards.js?v=20260503vv2').then(m => m.renderDashboards(content)); },
